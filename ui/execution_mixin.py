...
class ExecutionMixin:
    ...
    def _start_dub(self):
        ...
        self._pipeline_worker.ref_audio_ready.connect(self._on_ref_audio_ready)
        self._pipeline_worker.mix_audio_ready.connect(self._on_mix_audio_ready)
    ...
    def _run_single_step(self, step_idx: int):
        ...
        w.ref_audio_ready.connect(self._on_ref_audio_ready)
        w.mix_audio_ready.connect(self._on_mix_audio_ready)
